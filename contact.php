...
<section class="hero">
  <div class="hero-grid">
    ...
    <div class="hero-image fade-up">
      <img src="https://images.unsplash.com/photo-1581092335871-4b3c1d8e5d1f?q=80&w=2070&auto=format" alt="Ultrasonic testing technician inspecting industrial weld" loading="lazy">
    </div>
  </div>
</section>
    ...
    <div class="two-column-layout">
      ...
      <div class="form-card fade-up">
        <form id="ndtContactForm" method="POST">
          <div class="form-group">
            ...
            <input type="text" id="fullname" name="fullname" placeholder="James R. Carter" required>
          </div>
          <div class="form-group">
            <label for="email">Email address *</label>
            <input type="email" id="email" name="email" placeholder="james.carter@industry.com" required>
          </div>
          <div class="form-group">
            <label for="company">Company / Organization *</label>
            <input type="text" id="company" name="company" placeholder="EnergyCorp Inspection Ltd." required>
          </div>
          <div class="form-group">
      ...
      <div class="contact-methods-wrapper fade-up">
        <div class="contact-methods">
          <div class="contact-method-item">
            ...
            <div class="contact-detail">
              ...
              <p>+91 1800 123 6894<br>+91 22 4892 7710</p>
            </div>
          </div>
          <div class="contact-method-item">
            ...
            <div class="contact-detail">
              ...
              <p>inspection@alphasonixndt.com<br>projects@alphasonixndt.com</p>
            </div>
          </div>
          <div class="contact-method-item">
            ...
            <div class="contact-detail">
              ...
              <p>Alpha Sonix NDT Solutions,<br>Tech Park Tower, Andheri East, Mumbai - 400093, India</p>
            </div>
          </div>
        ...
        <div class="map-container">
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3770.482427216332!2d72.8697787742603!3d19.11303798205752!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c83f7b2c9b2d%3A0x8c2c8b2b8c8b2c8!2sAndheri%20East%2C%20Mumbai%2C%20Maharashtra%20400093!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin" 
            allowfullscreen="" 
            loading="lazy" 
            referrerpolicy="no-referrer-when-downgrade"
            title="Alpha Sonix NDT Office Location - Andheri East, Mumbai">
          </iframe>
        </div>
      </div>
    </div>
...
<section class="services-preview">
  <div class="page-container">
    ...
    <div class="service-grid">
      <div class="service-item fade-up"><i class="fas fa-waveform service-icon"></i><h4>Ultrasonics</h4><p>PAUT, TOFD, thickness</p></div>
      <div class="service-item fade-up"><i class="fas fa-magnet service-icon"></i><h4>Magnetic Particle</h4><p>Weld & cast inspection</p></div>
      <div class="service-item fade-up"><i class="fas fa-camera service-icon"></i><h4>Thermography</h4><p>Electrical & refractory</p></div>
      <div class="service-item fade-up"><i class="fas fa-x-ray service-icon"></i><h4>Digital Radiography</h4><p>Real-time imaging</p></div>
      <div class="service-item fade-up"><i class="fas fa-water service-icon"></i><h4>Liquid Penetrant</h4><p>Surface flaw detection</p></div>
      <div class="service-item fade-up"><i class="fas fa-charging-station service-icon"></i><h4>Eddy Current</h4><p>Conductive materials</p></div>
    </div>

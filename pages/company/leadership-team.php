...
<!-- Section 1: Leadership Philosophy - Content Left (Blue) | Image Right -->
<section class="mosaic-section">
    <div class="content-block blue">
        <h2 class="section-title-main">Our Leadership Philosophy</h2>
...
<!-- Section 2: CEO Profile - Image Left | Content Right (Yellow) -->
<section class="mosaic-section">
    <div class="image-block">
        <img src="https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=1200&h=800&fit=crop&q=80" alt="CEO Leadership">
    </div>
    <div class="content-block yellow">
        <div class="leader-profile-container">
            ...
            <div class="leader-quote">
                ...
                and build lasting partnerships. Our commitment to excellence is unwavering."</p>
            </div>
...
<!-- Section 3: Operations Manager - Content Left (Blue) | Image Right -->
<section class="mosaic-section">
    <div class="content-block blue">
        <div class="leader-profile-container">
            <div class="leader-header">
            ...
            <p class="leader-bio">
                ...
                expertise in NDT operations management, he oversees multi-site projects and maintains 
                the highest quality standards across all service deliveries.
            </p>
            ...
            <div class="leader-achievements">
                ...
                <ul class="achievements-list">
                    <li>Streamlined operations for 30% improvement in delivery timelines</li>
            ...
            <div class="leader-quote">
                ...
                systems that ensure every project is executed with precision and every deadline is met."</p>
            </div>
    ...
    <div class="image-block">
        <img src="../../assets/images/TOFD/bharath.jpeg" alt="Operations Management">
    </div>
</section>
<br>
...
<!-- Extended Management Team Section -->
...
<section class="leadership-cta-section">
    <div class="cta-content">
        ...
        <div class="cta-buttons">
            ...
            <a href="/www/contact.php" class="btn btn-secondary">Contact Leadership</a>
        </div>
    </div>
</section>
